...
public class UserRepository implements IUserRepo {
    ...
    private UserRepository() {
        ...
        clients.add(new User(1, "Oleg", "1111".hashCode(), 2));
        clients.add(new User(2, "Dmitry", "2222".hashCode(), 3));
        clients.add(new User(3, "Vladislav", "3333".hashCode(), 4));
        clients.add(new User(4, "Elena", "4444".hashCode(), 5));
    }
